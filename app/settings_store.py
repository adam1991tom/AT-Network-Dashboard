...
DEFAULT_SETTINGS: dict[str, str] = {
    ...
    "uptime_kuma_enabled":"false","uptime_kuma_url":"","uptime_kuma_status_slug":"","uptime_kuma_verify_ssl":"false",
...
SECRET_KEYS={"unifi_api_key","discord_webhook","uptime_kuma_api_key"}; INSTALL_KEY_PATH=Path("/data/install.key")
